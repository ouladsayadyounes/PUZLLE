...
var Game = new (function() {
  var self = this,
      ...
      currentPuzzle = null,
      checkTOH = 0,
      ojoos = ['Merveilleux', 'Spectaculaire', 'Merveilleux', 'Remarquable', 'Remarquable', 'Voilaaa', 'Impressionnant', 'Super', 'Bien Fait', 'Fabuleux', 'Intelligent', 'Eblouissant ',' Fantastique ',' Excellent ','Bravo',' Super ',' Génial ',' WooooW',' Brillant ',' Splendide ',' Exceptionnel ',' Magnifique ',' Ohhh Lala'],
      remainingOjoos = [],
      endGameTOH1,
      endGameTOH2,
      endGameTOH3,
  ...
  function init() {
    ...
    var colors = ['#FF5B2B', '#FF5B2B', '#FF5B2B']
  ...
  function start() {
    ...
    setTimeout(function(){$('.hide1').removeClass('hide1')}, 100);
    setTimeout(function(){$('.show01').removeClass('hidehs')}, 100);
    setTimeout(function(){$('.show01').removeClass('show01').addClass('hidehs'); addEventListeners();}, 200);
  }
  ...
  function undo() {
    if (!undoStack.length) {
      ...
      if (!undone)
        grid.hint.show('c\'est le boutton annuler');
      else

...
var TutorialMessages = {
  ...
  3: { msg: 'Trois carreaux Orange l\'une à côté de l\'autre n\'est pas autorisée.', tiles: [ [2,0,2] ] },
  4: { msg: 'Trois carreaux Jaune l\'une à côté de l\'autre n\'est pas autorisée Aussi', tiles: [ [1,1,1] ] },
  5: { msg: 'Trois carreaux orange ou jaune l\'une sous l\'autre ne sont pas valides non plus!', tiles: [ [1,2,2], [2,2,1] ] },
  6: { msg: 'Une ligne complète doit avoir autant de carreaux jaune que celles orange.', tiles: [ [3,1,1] ], rows: [1] },
  7: { msg: 'de meme pour les colonnes, ils doivent avoir autant de carreaux jaune que celles orange.', tiles: [ [1,3,2] ], cols: [1] },
  8: { msg: 'Vous devriez être capable de savoir de quelle couleur est celle-ci ...', tiles: [ [2,3,1] ] },
  9: { msg: 'La grille ne doit pas avoir deux lignes ou deux colonnes identiques', tiles: [ [0,3,1], [0,2,2],[3,2,1] ], rows:[2,3] },
 10: { msg: 'Si vous êtes coincé, appuyez sur l\'oeil pour jeter un coup d\'oeil.', tiles: [ [3,0,2] ], wiggle: true }
}

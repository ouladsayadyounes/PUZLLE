...
var HintType = {
  None: 'None',
  RowsMustBeUnique: 'Deux lignes Identiques Sont Interdites',
  ColsMustBeUnique: 'Deux Colonnes Identiques Sont Interdites',
  RowMustBeBalanced: 'Les lignes doivent avoir un nombre égal de chaque couleur.',
  ColMustBeBalanced: 'Les Colonnes doivent avoir un nombre égal de chaque couleur.',
  MaxTwoRed: 'Trois Carreaux Oranges l\'une à côté de l\'autre ne sont pas autorisées.',
  MaxTwoBlue: 'Trois Carreaux Jaunes l\'une à côté de l\'autre ne sont pas autorisées.',
  SinglePossibleRowCombo: 'une seule combinaison est possible ici.',
  SinglePossibleColCombo: 'une seule combinaison est possible ici.',
  Error: 'Celle-ci ne semble pas correcte.',
  Errors: 'Ces colbinaison ne semble pas correcte'
};
